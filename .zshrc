...
alias vimconfig="nv ~/.config/nvim/."
alias kittyconfig="nv ~/.config/kitty/kitty.conf"
alias xinitconfig="nv ~/.xinitrc"
alias bashrcconfig="nv ~/.bashrc"
alias ohmyzsh="nv ~/.oh-my-zsh"
alias dmenuconfig="nv ~/.config/demnu"
alias i3config="nv ~/.config/i3/config"
alias i3statusconfig="nv ~/.config/i3status/config"
